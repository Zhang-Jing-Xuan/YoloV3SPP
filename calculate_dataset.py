...
def change_and_create_cfg_file(classes_info, save_cfg_path="/home/mist/yolov3_spp/cfg/yolov3-spp.cfg"):
...
def main():
    ...
    train_txt_path = "/home/mist/yolov3_spp/data/my_train_data.txt"
    val_txt_path = "/home/mist/yolov3_spp/data/my_val_data.txt"
    ...
    create_data_data("/home/mist/yolov3_spp/data/my_data.data", classes_label, train_txt_path, val_txt_path, classes_info)
